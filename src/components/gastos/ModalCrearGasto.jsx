  ...
  const onSubmit = async (formData) => {
    try {
      ...
      const res = await client.post(
        `/proveedores/${proveedor}/comprobantes`,
        proveedorData
      );

      setProveedores(res.data.todosLosProveedores);

      console.log("asdasd", res.data.todosLosProveedores);
      ...
      document.getElementById("my_modal_crear_gasto").close();
