...
export const GastosIntro = () => {
  ...
  return (
    <div className="border-gray-300 bg-slate-100 rounded-md border-[1px] shadow-md shadow-black/20 py-10 px-10 flex justify-between items-center">
      ...
      <div className="border-gray-300 rounded-md border-[1px] shadow-md shadow-black/20 py-3 px-3 flex gap-10 bg-white">
        <div className="flex items-center gap-2">
          ...
          <p className="font-semibold text-indigo-500 text-md uppercase">
