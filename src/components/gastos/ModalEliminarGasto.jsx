...
export const ModalEliminarGasto = () => {
  const { closeModalEliminar, obtenerId, isOpenEliminar, handleEliminar } =
    useGastosContext();
            ...
            >
              <div className="w-1/2 inline-block p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl space-y-6">
                ...
                <div className="border-[1px] border-gray-200 rounded shadow-black/10 shadow flex gap-3 w-full py-10 px-10">
                  <button
                    onClick={() => handleEliminar(obtenerId)}
                    type="button"
                  ...
                  <button
                    ...
                    type="button"
                    className="w-full bg-indigo-200 py-2 px-4 rounded-md shadow border-teal-950 border-[1px] text-indigo-950 font-bold"
                  >
                    CERRAR
                  </button>
                </div>
