...
export const CrearGastosCategorias = ({ results }) => {
  ...
  return (
    <div className="border-slate-300 rounded-xl border-[1px] shadow py-5 px-10 flex gap-12 items-center bg-white">
      <button
        onClick={() => openModal()}
        className="border-slate-300 rounded-xl border-[1px] shadow  py-3 px-3 flex gap-10 font-bold cursor-pointer hover:bg-indigo-500/10 transition-all ease-in-out duration-400 hover:text-indigo-600 hover:shadow-md hover:shadow-black/10 hover:border-indigo-500 bg-white"
      >
        CREAR NUEVO VENTA
      </button>
      ...
      <button className="border-slate-300 rounded-xl border-[1px] shadow  py-3 px-3 flex gap-10 font-bold cursor-pointer hover:bg-indigo-500/10 transition-all ease-in-out duration-400 hover:text-indigo-600 hover:shadow-md hover:shadow-black/10 hover:border-indigo-500 bg-white">
